...
function Login({ handleSubmit, rememberedPhoneNumber }) {
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className={styles.remember__and__forgot__password__field}>
                  ...
                  <div>
                    <Link href={`${clientBasePath}/forgotpassword`}>
                      <a className={styles.forgot__password__link}>
                        Forgot Password?
                      </a>
                    </Link>
                  </div>
                ...
                <div className={styles.login__button__container}>
                  ...
                  <FormButton
                    ...
                    onClick={() => Router.push(`${clientBasePath}/register`)}
                  />
                </div>
              </form>
            )}
