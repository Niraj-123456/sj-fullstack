...
import { StaffDashboardSearchDTO } from './dashboard.dtos';
...
export class DashboardService {
  ...
  async getFilteredBookingListByStatus(
    staff: User,
    searchDetails: StaffDashboardSearchDTO,
    ...
    let totalBookingListByStatus = await this.bookingService
      ...
      .find({
        ...
        relations: ['staffWhoBooked', 'associatedServices'],
        where: {
          isDeleted: false,
    ...
    return {
      ...
      links: {
        firstPage: `${process.env.NODE_API_HOST}/pages/staff-web-app/dashboard/get-user-bookings-by-filter?numberOfMaxResultsInEachPage=${searchDetails.numberOfMaxResultsInEachPage}&pageNumber=${firstPageNumber}&bookingsDivision=${searchDetails.bookingsDivision}&filterType=${searchDetails.filterType}&status=${searchDetails.status}&bookingSortCriteria=${searchDetails.bookingSortCriteria}&sortValue=${searchDetails.sortValue}`,
        previousPage: `${process.env.NODE_API_HOST}/pages/staff-web-app/dashboard/get-user-bookings-by-filter?numberOfMaxResultsInEachPage=${searchDetails.numberOfMaxResultsInEachPage}&pageNumber=${previousPageNumber}&bookingsDivision=${searchDetails.bookingsDivision}&filterType=${searchDetails.filterType}&status=${searchDetails.status}&bookingSortCriteria=${searchDetails.bookingSortCriteria}&sortValue=${searchDetails.sortValue}`,
        currentPage: `${process.env.NODE_API_HOST}/pages/staff-web-app/dashboard/get-user-bookings-by-filter?numberOfMaxResultsInEachPage=${searchDetails.numberOfMaxResultsInEachPage}&pageNumber=${currentPageNumber}&bookingsDivision=${searchDetails.bookingsDivision}&filterType=${searchDetails.filterType}&status=${searchDetails.status}&bookingSortCriteria=${searchDetails.bookingSortCriteria}&sortValue=${searchDetails.sortValue}`,
        nextPage: `${process.env.NODE_API_HOST}/pages/staff-web-app/dashboard/get-user-bookings-by-filter?numberOfMaxResultsInEachPage=${searchDetails.numberOfMaxResultsInEachPage}&pageNumber=${nextPageNumber}&bookingsDivision=${searchDetails.bookingsDivision}&filterType=${searchDetails.filterType}&status=${searchDetails.status}&bookingSortCriteria=${searchDetails.bookingSortCriteria}&sortValue=${searchDetails.sortValue}`,
        lastPage: `${process.env.NODE_API_HOST}/pages/staff-web-app/dashboard/get-user-bookings-by-filter?numberOfMaxResultsInEachPage=${searchDetails.numberOfMaxResultsInEachPage}&pageNumber=${lastPageNumber}&bookingsDivision=${searchDetails.bookingsDivision}&filterType=${searchDetails.filterType}&status=${searchDetails.status}&bookingSortCriteria=${searchDetails.bookingSortCriteria}&sortValue=${searchDetails.sortValue}`,
      },
    };
  }
  ...
  async getFilteredBookingList(
    ...
    // booking division
    let bookingStatusList: BookingStatusEnum[];
