...
export const provinceListWithDistrict = [
  {
    'Province Name': 'Province No. 1',
    'Province Number': 'Province No. 1',
    'Districts': [
      'Bhojpur',       'Dhankuta',
      'Ilam',          'Jhapa',
      'Khotang',       'Morang',
      'Okhaldhunga',   'Panchthar',
  ...
  },
  {
    ...
    'Province Number': 'Province No. 3',
    'Districts': [
      'Sindhuli',       'Ramechhap',
      'Dolakha',        'Bhaktapur',
      'Dhading',        'Kathmandu',
      'Kavrepalanchok', 'Lalitpur',
      'Nuwakot',        'Rasuwa',
  ...
  },
  {
    ...
    'Province Number': 'Province No. 5',
    'Districts': [
      'Kapilvastu', 'Parasi',
      'Rupandehi',  'Arghakhanchi',
      'Gulmi',      'Palpa',
      'Dang',       'Pyuthan',
      'Rolpa',      'Eastern Rukum',
      'Banke',      'Bardiya'
  ...
  {
    'Province Name': 'SudurPaschim',
    'Province Number': 'Province No. 7',
    'Districts': [
      'Kailali',    'Achham',
      'Doti',       'Bajhang',
      'Bajura',     'Kanchanpur',
...
export const districtList = [
  ...
  'Khotang',        'Morang',       'Okhaldhunga',   'Panchthar',
  'Sankhuwasabha',  'Solukhumbu',   'Sunsari',       'Taplejung',
  'Terhathum',      'Udayapur',     'Saptari',       'Parsa',
  'Sarlahi',        'Bara',         'Siraha',        'Dhanusha',
  'Rautahat',       'Mahottari',    'Sindhuli',      'Ramechhap',
  'Dolakha',        'Bhaktapur',    'Dhading',       'Kathmandu',
  'Kavrepalanchok', 'Lalitpur',     'Nuwakot',       'Rasuwa',
  'Sindhupalchok',  'Chitwan',      'Makwanpur',     'Baglung',
  'Gorkha',         'Kaski',        'Lamjung',       'Manang',
  'Mustang',        'Myagdi',       'Nawalpur',      'Parbat',
  'Syangja',        'Tanahun',      'Kapilvastu',    'Parasi',
  'Rupandehi',      'Arghakhanchi', 'Gulmi',         'Palpa',
  'Dang',           'Pyuthan',      'Rolpa',         'Eastern Rukum',
  'Banke',          'Bardiya',      'Western Rukum', 'Salyan',
  'Dolpa',          'Humla',        'Jumla',         'Kalikot',
  'Mugu',           'Surkhet',      'Dailekh',       'Jajarkot',
  'Kailali',        'Achham',       'Doti',          'Bajhang',
  'Bajura',         'Kanchanpur',   'Dadeldhura',    'Baitadi',
  'Darchula'
]
